  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-foreground dark:text-white flex items-center gap-3">
            <User className="h-8 w-8 text-primary" />
            Mi Perfil
          </h1>
          <p className="text-muted-foreground dark:text-slate-400 mt-1 font-medium">Gestiona tu información personal y seguridad</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardContent className="pt-4">
            {!editMode ? (
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-black text-foreground dark:text-white mb-1">{perfil.nombres}</h2>
                    <Badge className={cn("rounded-lg px-3 py-1 border font-bold capitalize", getRoleColor(), "dark:border-white/10")}>
                      {perfil.nombreRol}
                    </Badge>
                    <p className="text-sm text-muted-foreground dark:text-slate-400 mt-3 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-black uppercase text-muted-foreground dark:text-slate-500 tracking-widest">
                      <Mail className="inline h-4 w-4 mr-1" />
                      Correo Electrónico
                    </label>
                    <p className="text-lg font-bold text-foreground dark:text-slate-200">{perfil.email}</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-lg font-mono font-bold text-foreground dark:text-slate-200">{perfil.dni}</p>
                  </div>
                  ...
                  {perfil.fechaCreacion && (
                    <div className="space-y-2">
                      ...
                      <p className="text-lg font-bold text-foreground dark:text-slate-200">
              ...
              <div className="space-y-6">
                 <div className="space-y-2">
                  <label className="text-xs font-black uppercase text-muted-foreground dark:text-slate-500 tracking-widest pl-1">
                    Nombre Completo
                  </label>
                  <Input
                    disabled
                    ...
                    className="h-12 rounded-2xl bg-secondary/30 dark:bg-slate-800 border-none focus:ring-2 focus:ring-primary/20 font-bold opacity-60 cursor-not-allowed text-foreground"
                  />
                </div>
                 ...
                 <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 rounded-2xl bg-secondary/30 dark:bg-slate-800 border-none focus:ring-2 focus:ring-primary/20 font-bold text-foreground"
                  />
                </div>
        ...
        <Card className="border-none shadow-xl bg-background/50 dark:bg-slate-900/50 backdrop-blur-sm ring-1 ring-border/50 dark:ring-slate-800">
          ...
          <CardContent className="pt-4 space-y-4">
            {!changePasswordMode ? (
              <>
                <div className="p-4 rounded-2xl bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/10 dark:border-blue-500/20">
